...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SMB Cyber Review — Independent Cybersecurity Reviews for Small Business" },
      { name: "description", content: "Independent 2026 reviews and comparisons of the best cybersecurity tools for small and mid-size businesses." },
      { property: "og:site_name", content: "SMB Cyber Review" },
